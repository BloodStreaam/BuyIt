...
INSERT or IGNORE INTO produtos (id, nome, preco, stock, un, desconto, preco_desconto, tipo, img) VALUES (1, 'Nesquik', 1.89, 60, "CX", 0, 0, 3, "https://images.jumpseller.com/store/comprar-em-casa/5483840/media.axd?0");
INSERT or IGNORE INTO produtos (id, nome, preco, stock, un, desconto, preco_desconto, tipo, img) VALUES (1, 'Crunch', 1.99, 40, "CX", 0, 0, 3, "https://media.continente.pt/Sonae.eGlobal.Presentation.Web.Media/media.axd?resourceSearchType=2&resource=ProductId=2572402(eCsf$RetekProductCatalog$MegastoreContinenteOnline$Continente)&siteId=1&channelId=1&width=512&height=512&defaultOptions=1");
INSERT or IGNORE INTO produtos (id, nome, preco, stock, un, desconto, preco_desconto, tipo, img) VALUES (1, 'Bife do Lombo de Vitelão', 15.99, 30, "KG", 0, 0, 4, "https://media.continente.pt/Sonae.eGlobal.Presentation.Web.Media/media.axd?resourceSearchType=2&resource=ProductId=5560188(eCsf$RetekProductCatalog$MegastoreContinenteOnline$Continente)&siteId=1&channelId=1&width=150&height=150&defaultOptions=1");
INSERT or IGNORE INTO produtos (id, nome, preco, stock, un, desconto, preco_desconto, tipo, img) VALUES (1, 'Bifana de Porco', 3.49, 30, "KG", 0, 0, 4, "https://media.continente.pt/Sonae.eGlobal.Presentation.Web.Media/media.axd?resourceSearchType=2&resource=ProductId=4285344(eCsf$RetekProductCatalog$MegastoreContinenteOnline$Continente)&siteId=1&channelId=1&width=150&height=150&defaultOptions=1");
INSERT or IGNORE INTO produtos (id, nome, preco, stock, un, desconto, preco_desconto, tipo, img) VALUES (1, 'Espinha /Suã de Porco com Osso Continente', 1.39, 30, "KG", 0, 0, 4, "https://media.continente.pt/Sonae.eGlobal.Presentation.Web.Media/media.axd?resourceSearchType=2&resource=ProductId=2231762(eCsf$RetekProductCatalog$MegastoreContinenteOnline$Continente)&siteId=1&channelId=1&width=150&height=150&defaultOptions=1");
